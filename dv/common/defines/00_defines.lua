...
NDiplomacy = {
	...
	JOIN_FACTION_LIMIT_CHANGE_AT_WAR = -0.1,			-- if in defensive war this or your modifier is counted as limit to join factions (so if you have 80% join limit this now means you can join at 50%)
